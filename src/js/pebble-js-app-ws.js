/**
* PGE PebbleKit JS file.
* The section marked with 'DO NOT MODIFY' should not be modified to preserve functionality
* with pge_ws.h
*/

/******************************** Config **************************************/

var DEBUG = true;           // Print debug logging
var VERBOSE = true;         // Print all logging
var NUM_APPINFO_KEYS = 16;  // Number of PGE_WS_KEY_X keys declared in appinfo.json 
                            // with values of X of 0 -> NUM_APPINFO_KEYS
...
function onSocketMessage(data) {
  // Auto-forward PGE_WS_KEY_ data to Pebble
...
Pebble.addEventListener('ready', function() {
  ...
  // Send this event to trigger PGEWSConnectedHandler
  PGEWSReady();
});

Pebble.addEventListener('appmessage', function(dict) {
  // Handle and PGE WS protocol messages
  PGEWSAppMessageProtocol(dict);

  // Auto-forward PGE_WS_KEY_ data to server
